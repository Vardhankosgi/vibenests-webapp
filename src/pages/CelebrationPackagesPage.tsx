...
const mockPackages: Package[] = [
  {
    ...
    capacity: 50,
    description: "Elegant celebration space with decorative setup and catering options",
    image: "https://images.unsplash.com/photo-1519671482749-fd09be7ccebf?w=600&h=400&fit=crop",
    badge: "Most Popular",
    amenities: ["Decoration", "Catering", "DJ Setup", "Lighting", "Sound System"],
    reviews: 248,
    rating: 4.8,
    booked: 1203,
  },
  {
    ...
    capacity: 4,
    description: "Intimate luxury suite with champagne and rose petals included",
    image: "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600&h=400&fit=crop",
    badge: "Best for Couples",
    amenities: ["Champagne", "Roses", "Spa Access", "Private Dinner", "Jacuzzi"],
    reviews: 156,
    rating: 4.9,
    booked: 842,
  },
  {
    id: "CP003",
    name: "Intimate Proposal Setup",
    occasion: "Proposal",
    price: 6500,
    priceRange: [5000, 8000],
    capacity: 2,
    description: "Candlelit room with personalized decorations and champagne service",
    image: "https://images.unsplash.com/photo-1519225421-452d196e6235?w=600&h=400&fit=crop",
    badge: "Perfect Surprise",
    amenities: ["Candles", "Flowers", "Champagne", "Music", "Photography"],
    reviews: 189,
    rating: 4.9,
    booked: 567,
  },
  {
    id: "CP004",
    name: "Grand Party Paradise",
    occasion: "Birthday",
    price: 15000,
    priceRange: [12000, 18000],
    capacity: 100,
    description: "Full entertainment package with dance floor and professional DJ",
    image: "https://images.unsplash.com/photo-1516534775068-bb57c960fbb1?w=600&h=400&fit=crop",
    badge: "Great for Parties",
    amenities: ["DJ", "Dance Floor", "Bar Service", "Catering", "Entertainment"],
    reviews: 312,
    rating: 4.7,
    booked: 2156,
  },
  {
    ...
    capacity: 40,
    description: "Pastel-themed space with games, catering, and special decor",
    image: "https://images.unsplash.com/photo-1526047932273-b5b99c4476d4?w=600&h=400&fit=crop",
    badge: "Most Popular",
    amenities: ["Themed Decor", "Games", "Catering", "Photography", "Setup"],
    reviews: 94,
    rating: 4.8,
    booked: 423,
  },
  {
    ...
    capacity: 150,
    description: "Professional venue with AV setup, conference facilities, and catering",
    image: "https://images.unsplash.com/photo-1519167758481-83f19106049c?w=600&h=400&fit=crop",
    badge: "Most Popular",
    amenities: ["AV Setup", "Conference Tech", "Catering", "WiFi", "Parking"],
    reviews: 267,
    rating: 4.8,
    booked: 1834,
  },
  {
    id: "CP007",
    name: "Enchanted Garden Celebration",
    occasion: "Other Celebrations",
    price: 7500,
    priceRange: [6000, 9000],
    capacity: 60,
    description: "Outdoor-inspired setup with floral arrangements and ambient lighting",
    image: "https://images.unsplash.com/photo-1511632765486-a01980e01a18?w=600&h=400&fit=crop",
    badge: "Perfect Surprise",
    amenities: ["Floral Setup", "Ambient Lighting", "Outdoor Space", "Catering", "Setup"],
    reviews: 143,
    rating: 4.6,
    booked: 612,
  },
  {
    id: "CP008",
    name: "Luxe Celebration Premium",
    occasion: "Anniversary",
    price: 9500,
    priceRange: [8000, 12000],
    capacity: 20,
    description: "Private villa setting with gourmet dining and personalized service",
    image: "https://images.unsplash.com/photo-1520763185298-1b434c919eba?w=600&h=400&fit=crop",
    badge: "Best for Couples",
    amenities: ["Gourmet Dining", "Private Villa", "Concierge", "Wine Selection", "Spa"],
    reviews: 201,
    rating: 4.9,
    booked: 745,
  },
...
export default function CelebrationPackagesPage() {
  ...
  const sorted = useMemo(() => {
    ...
    switch (sortBy) {
      case "popularity":
        return copy.sort((a, b) => b.booked - a.booked);
      case "price-low":
        ...
        <div className="space-y-4 mb-6">
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="relative flex-1">
              ...
              <input
                type="text"
                placeholder="Search packages by name or occasion..."
                value={search}
                onChange={(e) => {
            ...
            >
              <option value="popularity" className="bg-[oklch(0.13_0.025_260)]">
                Popularity
              </option>
              <option value="price-low" className="bg-[oklch(0.13_0.025_260)]">
                Price: Low to High
              </option>
              <option value="price-high" className="bg-[oklch(0.13_0.025_260)]">
                Price: High to Low
              </option>
              <option value="booked" className="bg-[oklch(0.13_0.025_260)]">
                Most Booked
              </option>
            </select>
            <button
            ...
            {compareItems.size > 0 && (
              <button
                ...
                className="flex items-center gap-2 px-4 py-2.5 rounded-lg border border-[var(--gold)]/30 text-gold hover:bg-[var(--gold)]/10 transition font-medium text-sm"
              >
          ...
          {showFilters && (
            <div className="w-full sm:w-64 flex-shrink-0">
              <div className="glass-card rounded-2xl p-4 border border-[var(--gold)]/10 space-y-4 sticky top-6">
                ...
                <div>
                  <label className="text-xs text-muted-foreground uppercase tracking-wide font-medium block mb-3">
                    Occasions
                  </label>
                    ...
                    {OCCASIONS.map((occasion) => (
                      <label key={occasion} className="flex items-center gap-2 cursor-pointer group">
                        ...
                        <span className="text-xs text-muted-foreground/60 ml-auto">
                          ({mockPackages.filter((p) => p.occasion === occasion).length})
                        </span>
                      </label>
                    ))}
                  </div>
                ...
                <div className="border-t border-white/10 pt-4">
                  <p className="text-xs text-muted-foreground">
                    <span className="text-foreground font-medium">{sorted.length}</span> packages found
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex-1">
            {paginatedPackages.length === 0 ? (
              <div className="py-16 text-center">
                ...
                <p className="text-muted-foreground">No packages match your criteria</p>
              </div>
            ) : (
              <>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {paginatedPackages.map((pkg) => (
                    <div
                      key={pkg.id}
                      className="group glass-card rounded-2xl overflow-hidden border border-[var(--gold)]/10 hover:border-[var(--gold)]/30 transition-all duration-300 flex flex-col"
                    >
                      {/* Image Section */}
                      <div className="relative h-48 overflow-hidden bg-white/5">
                        ...
                        {/* Badge */}
                        <div className={`absolute top-3 right-3 px-3 py-1 rounded-full text-[11px] font-medium border ${badgeStyles[pkg.badge]} backdrop-blur-sm`}>
                          {pkg.badge}
                        </div>
                        ...
                        <button
                          ...
                          className="absolute top-3 left-3 h-8 w-8 rounded-full bg-black/40 backdrop-blur-sm flex items-center justify-center hover:bg-black/60 transition border border-white/10"
                        >
                          <Heart
                            className={`h-4 w-4 transition ${
                              favorites.has(pkg.id) ? "fill-red-500 text-red-500" : "text-white/60 hover:text-white"
                            }`}
                          />
                        </button>
                      </div>
                      ...
                      <div className="p-4 flex flex-col gap-3 flex-1">
                          ...
                          <div className="flex items-center gap-1 mt-1">
                            <div className="flex items-center gap-0.5">
                              {[...Array(5)].map((_, i) => (
                                <Star
                                  key={i}
                                  className={`h-3 w-3 ${i < Math.floor(pkg.rating) ? "fill-gold text-gold" : "text-muted-foreground/40"}`}
                                />
                              ))}
                            </div>
                        ...
                        <div className="flex flex-wrap gap-1">
                          {pkg.amenities.slice(0, 3).map((amenity, i) => (
                            <span key={i} className="text-xs bg-white/5 text-muted-foreground px-2 py-1 rounded border border-white/10">
                              {amenity}
                            </span>
                          ))}
                          ...
                          <div className="flex gap-2">
                            {compareMode && (
                              <button
                                ...
                                className={`h-8 w-8 rounded border transition flex items-center justify-center ${
                                  compareItems.has(pkg.id)
                                    ? "bg-gold/10 border-gold text-gold"
                                    : "border-white/10 text-muted-foreground hover:border-[var(--gold)]/30"
                                }`}
                              >
                ...
                {totalPages > 1 && (
                  <div className="flex items-center justify-center gap-2 mt-8">
                    ...
                    {[...Array(totalPages)].map((_, i) => {
                      const page = i + 1;
                      const isEllipsis = Math.abs(page - currentPage) > 1 && page !== 1 && page !== totalPages;
                        ...
                        <button
                          ...
                          className={`h-8 w-8 rounded-lg text-sm font-medium transition ${
                            currentPage === page
                              ...
                              : "border border-white/10 text-muted-foreground hover:text-foreground hover:border-[var(--gold)]/30"
                          }`}
                        >
                          {page}
                        </button>
